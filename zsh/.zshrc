...
# Optionally, if you set this to "random", it will load a random theme each time you open a new terminal.
ZSH_THEME="robbyrussell"

# Uncomment the following line to use case-sensitive completion.
# CASE_SENSITIVE="true"

# Uncomment the following line to use hyphen-insensitive completion. Case-sensitive completion must be off.
...
# You can set it to the format you prefer, for example:
